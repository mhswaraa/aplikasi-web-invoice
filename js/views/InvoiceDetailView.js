...
export const InvoiceDetailView = {
  render() {
    ...
    // Build HTML tabel, sertakan kolom Model
    ...
    app.innerHTML = `
      <div id="invoice-detail" class="invoice-pdf-container">
        ...
        <table class="pdf-table">
          <thead>
            <tr>
              <th>No</th><th>Description</th><th>Model</th><th>Size</th>
  ...
  afterRender() {
    ...
    // Download laporan operasional (tampilkan op-report, cetak, lalu kembalikan)
